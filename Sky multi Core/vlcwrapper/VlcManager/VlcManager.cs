...
namespace Sky_multi_Core.VlcWrapper
{
    public sealed partial class VlcManager : IDisposable
    {
        ...
        {
            VlcLibraryLoader.LoadLibVlc(ref dynamicLinkLibrariesPath);
            ...
            try
            {
                ...
                lock (utf8Args)
                {
                    myVlcInstance = new VlcInstance(this, VlcNative.libvlc_new(utf8Args.Length, utf8Args));
        ...
        {
            get { return this.CouldPlayi(myMediaPlayerInstance); }
        }
        ...
        {
            get { return this.IsSeekablei(myMediaPlayerInstance); }
        }
        ...
        {
            return this.GetVideoScale(myMediaPlayerInstance);
        }

        public void SetScale(float factor)
        {
            this.SetVideoScale(myMediaPlayerInstance, factor);
        }
