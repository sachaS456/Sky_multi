...
namespace Sky_multi_Core
{
    ...
    /// </summary>
    internal sealed class VlcLibraryLoader: IDisposable
    {
        ...
        private VlcLibraryLoader(ref DirectoryInfo dynamicLinkLibrariesPath)
        {
        ...
        internal T GetInteropDelegate<T>()
        {
            ...
            try
            {
                ...
                lock (this._myInteropDelegatesLockObject)
                {
                    ...
                    var delegateForFunctionPointer = MarshalHelper.GetDelegateForFunctionPointer<T>(ref procAddress);
        ...
        internal static VlcLibraryLoader GetOrCreateLoader(ref DirectoryInfo dynamicLinkLibrariesPath)
        {
            ...
            lock (myLoaderInstances)
            {
                ...
                var returnedInstance = new VlcLibraryLoader(ref dynamicLinkLibrariesPath);
        ...
        internal static void ReleaseLoader(VlcLibraryLoader loader)
        {
            lock (myLoaderInstances)
            {
                loader.myRefCount--;
